...
function groupByDate(messages) {
  ...
  messages.forEach(msg => {
    ...
    if (day !== currentDate) {
      currentDate = day
      groups.push({ type: 'date', label: formatDateLabel(msg.created_at), key: day })
    }
      ...
      <div className="chat-header">
        <div className="chat-header-user">
          <div className="avatar-wrap">
            <img
              src={conversation.otherUser?.avatar_url || `https://api.dicebear.com/7.x/initials/svg?seed=${conversation.otherUser?.username || 'U'}`}
